  ...
  <section class="hero relative min-h-screen flex flex-col items-center justify-center pt-20 pb-10 overflow-hidden" id="hero">
    ...
    <div class="hero-content container relative z-10 animate-fade-in w-full text-center">
      ...
      <div class="hero-actions mt-12 flex gap-6 justify-center flex-wrap">
        ...
        <?php else: ?>
        <button @click="window.dispatchEvent(new CustomEvent('open-register'))" class="btn btn-primary btn-xl text-lg font-bold rounded-full shadow-[0_0_25px_rgba(59,130,246,0.6)] focus:ring-4 focus:ring-yellow-400 transition-all hover:-translate-y-1 hover:scale-105">
          <i class="fas fa-rocket text-xl mr-2 animate-pulse"></i> Comenzar Aventura
        </button>
        <button @click="openLoginModal(event)" class="btn btn-ghost btn-xl text-lg font-bold rounded-full border-2 border-gray-400 hover:border-white focus:ring-4 focus:ring-yellow-400 transition-all hover:bg-white/10 hover:-translate-y-1 hover:scale-105">
  ...
  <section class="py-24 relative z-10 w-full overflow-hidden" id="cta">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl text-center relative z-10 w-full">
      ...
      <div class="flex flex-col sm:flex-row gap-6 justify-center items-center w-full">
        ...
        <?php else: ?>
        <button @click="window.dispatchEvent(new CustomEvent('open-register'))" class="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white rounded-full bg-gradient-to-r from-purple-600 to-pink-600 shadow-[0_0_30px_rgba(168,85,247,0.6)] hover:shadow-[0_0_50px_rgba(236,72,153,0.8)] transform hover:scale-105 transition-all duration-300 animate-float">
          <i class="fas fa-rocket mr-3 text-xl"></i> Crear Cuenta Gratis
        </button>
        <button @click="window.dispatchEvent(new CustomEvent('open-login'))" class="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white rounded-full bg-gray-800/80 border border-gray-600 backdrop-blur-sm hover:bg-gray-700 hover:border-blue-400 hover:shadow-[0_0_20px_rgba(59,130,246,0.4)] transform hover:scale-105 transition-all duration-300">
